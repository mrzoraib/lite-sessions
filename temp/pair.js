...
🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://whatsapp.com/channel/0029Vac8SsLY6d7CAFndv3Z) 

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [Malvin King GitHub Repo](https://github.com/mrzoraib/)  

🚀 _Thanks for choosing LITE-XD — Let the automation begin!_ ✨`;

                    await Malvin.sendMessage(Malvin.user.id, { text: ZORAIB_TEXT }, { quoted: session });

                    await delay(100);
                    await Zoraib.ws.close();
